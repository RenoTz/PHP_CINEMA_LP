...
CREATE TABLE IF NOT EXISTS `critiques` (
  ...
  PRIMARY KEY (`id`),
  KEY `film_id` (`film_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Critiques des films' AUTO_INCREMENT=8 ;
...
(2, 'Glenn', 'pas mal', 4, 2),
(3, 'no comment', 'une fin incroyable et nous laisse dubitatif..', 4, 4),
(4, 'John', 'Yipikay, pauvre con!', 5, 5),
